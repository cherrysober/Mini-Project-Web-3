					...
					<div class="col-md-12">
						<div class="wrapper px-md-4">
							<div class="row mb-5">
				        		...
				        		<div class="text">
					            <p><span>Phone:</span> <a href="tel://1234567920">0812345618</a></p>
					          </div>
				          </div>
								</div>
								<div class="col-md-3">
				        		...
				        		<div class="text">
					            <p><span>Email:</span> <a href="mailto:candlestore@gmail.com">candlestore@gmail.com</a></p>
					          </div>
				          </div>
								</div>
								<div class="col-md-3">
				        		...
				        		<div class="text">
					            <p><span>Website</span> <a href="#">candlestore.com</a></p>
					          </div>
				          </div>
								</div>
							</div>
							<div class="row no-gutters">
								...
								<div class="col-md-5 order-md-first d-flex align-items-stretch">
									<img src="images/kind_1.jpeg" class="map img-fluid" alt="Map Image" style="max-width: 100%; height: auto;">
								</div>
